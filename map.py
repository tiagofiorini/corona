...
for data in datas:
    ...
    plt.text(-70,-23,'TFSilva-IFUSP',fontsize=8)
    plt.text(-70,-24,'Dados: github.com/wcota',fontsize=6)
    plt.tight_layout()
    plt.savefig('./figs/fig_'+data+'.png')
    plt.close()
...
string_command = 'convert -delay 25 -loop 0 *.png fig_animated.gif'
